    ...
    for addr_lower, sig in addr_map.items():
        ...
        if new_status != old_status:
            ...
            if update_signal_status(sig['id'], new_status):
                ...
                # REPLY pada signal asal — trigger notification, mudah trace
                ...
                if new_status in alert_msgs and sig.get('tg_msg_id'):
                    reply_telegram_message(sig['tg_msg_id'], alert_msgs[new_status])
